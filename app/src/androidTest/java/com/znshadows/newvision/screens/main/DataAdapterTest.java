...
public class DataAdapterTest extends RecyclerView.Adapter<DataAdapterTest.DataViewHolder> {
    ...
    public DataAdapterTest(List<Item> items, OnItemClickListener onItemClickListener) {
